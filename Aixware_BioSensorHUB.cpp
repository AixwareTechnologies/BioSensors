...
uint8_t Aixware_BioSensorHUB::begin( TwoWire &wirePort ) {
  ...
  //Leer device mode
  uint8_t responseByte = read_byte_i2c(0x02, 0x00); 
  return responseByte; 
}
...
uint8_t Aixware_BioSensorHUB::read_status_HUB(){
  ...
  _i2cPort->requestFrom(_address_hr_sensor, (uint8_t)2); 
...
//--------------------------------------------------------------------------------------
//Configruación para AGC Control algorithm
//   cont_tries=0;
//   do {
...
//   do {
//     status = write_byte_i2c(0x10, 0x00, 0x03);
...
//   do {
//   status = write_byte_i2c(0x10, 0x01, 0x05);
...
//   do { 
//     status = write_byte_i2c(0x10, 0x02, 0x01);
...
//   //Auto PD (Error 2)
//   do {
//     status = write_byte2_i2c(0x50, 0x07, 0x12, 0x00);
...
//   //Enable SCD (error 2)
//   do {
//     status = write_byte2_i2c(0x50, 0x07, 0x0C, 0x00);
//     Serial.print("SCD: ");
//     Serial.println(status);
//     if (status != 0x00) return status;
//     cont_tries++;
...
//   do{
//     status = write_byte3_i2c(0x50, 0x07, 0x11, 0x00, 0x64);
...
//----------------------------------------------------------------------------------------------------
//Configuración para RAW DATA 

//   cont_tries=0;
//   //Set output mode to sensor data 
//   do {
//     status = write_byte_i2c(0x10, 0x01, 0x08);
//     Serial.print("output mode: ");
//     Serial.println(status);
//     if (status != 0x00) return status;
//     cont_tries++;
...
//   //Set output mode to sensor data 
//   do {
//     status = write_byte2_i2c(0x44, 0x00, 0x01, 0x00);
//     Serial.print("output mode: ");
//     Serial.println(status);
//     if (status != 0x00) return status;
//     cont_tries++;
...
//   // report rate (Error 1: command invalid)
//   do { 
//     status = write_byte2_i2c(0x40, 0x00, 0x11, 0x3F);
//     Serial.print("report rate: ");
//     Serial.println(status);
//     if (status != 0x00) return status;
//     cont_tries++;
...
//   // Algorithm operation (Error 2)
//   do {
//     status = write_byte2_i2c(0x40, 0x00, 0x12, 0x18);
//     Serial.print("Alg op mode: ");
//     Serial.println(status);
//     if (status != 0x00) return status;
//     cont_tries++;
...
//   // Enable AEC (Error 2)
//   do {
//     status = write_byte2_i2c(0x40, 0x00, 0x20, 0x21);
//     Serial.print("AEC: ");
//     Serial.println(status);
//     if (status != 0x00) return status;
//     cont_tries++;
...
//   //Auto PD (Error 2)
//   do {
//     status = write_byte2_i2c(0x40, 0x00, 0x2A, 0x3C);
//     Serial.print("Auto PD: ");
//     Serial.println(status);
//     if (status != 0x00) return status;
//     cont_tries++;
...
//   //Enable SCD (error 2)
//   do {
//     status = write_byte2_i2c(0x40, 0x00, 0x21, 0x03);
//     Serial.print("SCD: ");
//     Serial.println(status);
//     if (status != 0x00) return status;
//     cont_tries++;
...
//   //Enable SCD (error 2)
//   do {
//     status = write_byte2_i2c(0x40, 0x00, 0x22, 0x00);
//     Serial.print("SCD: ");
//     Serial.println(status);
//     if (status != 0x00) return status;
//     cont_tries++;
...
//   //Enable SCD (error 2)
//   do {
//     status = write_byte2_i2c(0x40, 0x00, 0x23, 0x30);
//     Serial.print("SCD: ");
//     Serial.println(status);
//     if (status != 0x00) return status;
//     cont_tries++;
...
//   //Enable SCD (error 2)
//   do {
//     status = write_byte2_i2c(0x40, 0x00, 0x24, 0x00);
//     Serial.print("SCD: ");
//     Serial.println(status);
//     if (status != 0x00) return status;
//     cont_tries++;
...
//   //Enable SCD (error 2)
//   do {
//     status = write_byte2_i2c(0x40, 0x00, 0x25, 0x00);
//     Serial.print("SCD: ");
//     Serial.println(status);
//     if (status != 0x00) return status;
//     cont_tries++;
...
//   //Enable SCD (error 2)
//   do {
//     status = write_byte2_i2c(0x40, 0x00, 0x2A, 0x3F);
//     Serial.print("SCD: ");
//     Serial.println(status);
//     if (status != 0x00) return status;
//     cont_tries++;
...
//   //Enable SCD (error 2)
//   do {
//     status = write_byte2_i2c(0x40, 0x00, 0x09,0x7C);
//     Serial.print("SCD: ");
//     Serial.println(status);
//     if (status != 0x00) return status;
//     cont_tries++;
...
//   //Enable SCD (error 2)
//   do {
//     status = write_byte2_i2c(0x40, 0x00, 0x0A,0x0E);
//     Serial.print("SCD: ");
//     Serial.println(status);
//     if (status != 0x00) return status;
//     cont_tries++;
...
//   //Enable SCD (error 2)
//   do {
//     status = write_byte2_i2c(0x40, 0x00, 0x02,0xC6);
//     Serial.print("SCD: ");
//     Serial.println(status);
//     if (status != 0x00) return status;
//     cont_tries++;
...
uint8_t Aixware_BioSensorHUB::readdacc() {
  ...
  _i2cPort->requestFrom(_address_hr_sensor, (uint8_t)3); 
...
uint8_t Aixware_BioSensorHUB::readsensormode() {
    ...
    _i2cPort->requestFrom(_address_hr_sensor, (uint8_t)1); 
...
uint8_t Aixware_BioSensorHUB::read_address_HUB()
{
  ...
  _i2cPort->requestFrom(_address_hr_sensor, (uint8_t)4); 
  //Primero se lee el estatus
  uint8_t statusByte = _i2cPort->read();
...
uint8_t  Aixware_BioSensorHUB::read_byte_i2c_temp(uint8_t _registerbyte)
{
  ...
  _i2cPort->requestFrom(_address_temp_sensor, (uint8_t)1); 
  statusByte = _i2cPort->read();
...
uint8_t* Aixware_BioSensorHUB::ReadFifo(uint8_t _familyByte, uint8_t _indexByte, uint8_t array[24] )
{
  ...
  _i2cPort->requestFrom(_address_hr_sensor, (uint8_t)25);
  statusByte = _i2cPort->read(); 
